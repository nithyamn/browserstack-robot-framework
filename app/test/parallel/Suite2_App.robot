...
Appium Test on BrowserStack
    ...
    Open Application    ${REMOTE_URL}    name=parallel_test    build=RobotFramework    platformName=Android    os_version=10.0    device=Google Pixel 4    app=%{BROWSERSTACK_APP_ID}
	# id=org.wikipedia.alpha:id/search_container
