...
Appium Test on BrowserStack
    ...
    Open Application    ${REMOTE_URL}    app=bs://ae210c1d04aa89db927c408f6d7da115303fba0d    name=single_test    build=RobotFramework    platformName=Android    os_version=7.0    device=Samsung Galaxy S8
	# id=org.wikipedia.alpha:id/search_container
