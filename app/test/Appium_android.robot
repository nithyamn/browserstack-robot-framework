...
Appium Test on BrowserStack
    ...
    Open Application    ${REMOTE_URL}    name=single_test    build=RobotFramework    platformName=Android    os_version=7.0    device=Samsung Galaxy S8    app=bs://ae210c1d04aa89db927c408f6d7da115303fba0d
	# id=org.wikipedia.alpha:id/search_container
